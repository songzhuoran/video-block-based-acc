...
IDX_DIR="../data/idx/"
MVS_DIR="../data/mvs/"
P_DIR="/home/songzhuoran/video/video-block-based-acc/davis2016/annotation/"
B_OUT_DIR="../data/train/"
B_DIR="../data/train/bframe/"
...
def bframe_gen_kernel(fcnt):
    ...
    cv2.imwrite(B_OUT_DIR+"bframe/"+classname+"_%05d.png" % fcnt,bframe_img)
    # exit()
...
def DFS(fcnt):
    ...
    if vis[fcnt]:
        ...
        frame_mat[fcnt] = cv2.imread(B_DIR+"/"+classname+"_%05d.png" % fcnt,0)
        vis[fcnt] = True
        return True
