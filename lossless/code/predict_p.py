...
IPframe_SRC_DIR = '/home/songzhuoran/video/video-block-based-acc/davis2016/annotation/'
IPframe_IDX_DIR = '../data/idx/p/'
FAVOS_DIR = '/home/songzhuoran/video/video-block-based-acc/lossless/data/favos_add_Sseg_CRF_Tracker/'
...
def image_segmentation_generator( images_path , segs_path ,  batch_size,  n_classes , input_height , input_width , output_height , output_width  , do_augment=False ):
	...
	while True:
		...
		for _ in range( batch_size) :
			...
			X.append( get_image_arr(im, im, im, input_width , input_height ,odering=IMAGE_ORDERING)  )
...
def predict( model=None , inp=None , out_fname=None , checkpoints_path=None  ):
	...
	# im_i = cv2.imread(FAVOS_DIR + Bframe_filename + '/%05d.png' % idx_i , 1 )
	# im_p = cv2.imread(FAVOS_DIR + Bframe_filename + '/%05d.png' % idx_p , 1 )
	...
	x = get_image_arr( inp, inp, inp , input_width  , input_height , odering=IMAGE_ORDERING )
...
INPUT_P_DIR = "/home/songzhuoran/video/video-block-based-acc/mapping-propa/"
OUTPUT_P_DIR = "/home/songzhuoran/video/video-block-based-acc/lossless/data/val/result_p/"
pflist = []
IDX_DIR="../data/idx/"

dir_list = os.listdir(INPUT_P_DIR)
for dir in dir_list: # dir = bear
	pflist = []
	...
	for pf in pflist:
		curstr = '%05d' % pf
		INPUT_DIR = INPUT_P_DIR + dir + "/" + curstr + ".png"
		OUTPUT_DIR = OUTPUT_P_DIR + dir + "/" + curstr + ".png"

		out = model.predict_segmentation(
			inp=INPUT_DIR, #input directory
			out_fname=OUTPUT_DIR, #result directory
